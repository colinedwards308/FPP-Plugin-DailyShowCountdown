...
install -d -o fpp -g fpp -m 2775 "${MEDIADIR}/plugindata/FPP-Plugin-DailyShowCountdown"
touch "${LOGDIR}/plugin-FPP-Plugin-DailyShowCountdown.log"
chown fpp:fpp "${LOGDIR}/plugin-FPP-Plugin-DailyShowCountdown.log"
chmod 664 "${LOGDIR}/plugin-FPP-Plugin-DailyShowCountdown.log"
